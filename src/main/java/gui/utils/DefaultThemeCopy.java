...
public class DefaultThemeCopy {
    /**
     * This is a copy of <code>definition</code> in the <code>DefaultTheme</code> class extending
     * {@link com.googlecode.lanterna.graphics.AbstractTheme AbstractTheme}.
     * <p>
     * It's given {@link #properties here} as a {@link Properties} object.
     */
    @SuppressWarnings({"SpellCheckingInspection", "TextBlockMigration"})
    public static final String definition = "# This is the default properties\n" +
            ...
            "\n" +
            "#Button\n" +
            "com.googlecode.lanterna.gui2.Button.renderer = com.googlecode.lanterna.gui2" +
    ...
    /**
     * The default Lanterna properties, generated from the {@link #definition}.
     */
